...
class Column(pygame.sprite.Sprite):
    def __init__(self, *group):
        self._layer = Layer.OBSTALE
        self.gap = 100

        self.sprite = asset.get_sprite("pipe-green")
        ...
        # สร้าง pipe ด้านบน ด้านล่าง ให้ transparent
        ...
        sprite_floor_height = asset.get_sprite("floor").get_rect().height
        min_y = 100
